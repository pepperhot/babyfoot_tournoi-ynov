...
try {
    // 8. Ajouter les colonnes goals et gamelles à scores
...
echo "<p><a href='public/players.php' style='color: #667eea; font-weight: bold;'>→ Voir les participants (NOUVEAU !)</a></p>";
