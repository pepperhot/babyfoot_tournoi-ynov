<div class="animate-fade-in">
    <div class="flex-between flex-wrap" style="margin-bottom: 20px;">
        ...
        <div class="badge-count" style="padding: 10px 20px; border-radius: 20px; font-weight: 600; background: var(--primary); color: white;">
    ...
    <div class="modal-content animate-fade-in" style="background: white; margin: 10% auto; padding: 20px; width: 90%; max-width: 500px; border-radius: var(--radius-lg); position: relative;">
        ...
        <form method="POST" action="players.php" id="inviteForm">
            ...
            <div class="flex-row gap-sm">
                <button type="submit" class="btn-primary flex-1">📨 Envoyer</button>
